...
bin/orcid-access-ws $DBSECURE_OPT $DBHOST_OPT $DBNAME_OPT $DBUSER_OPT $DBPASSWD_OPT $ORCID_PUBLIC_URL_OPT $ORCID_SECURE_URL_OPT $ORCID_OAUTH_URL_OPT $ORCID_CLIENT_ID_OPT $ORCID_CLIENT_SECRET_OPT $TOKENURL_OPT $TIMEOUT_OPT $DEBUG_OPT
